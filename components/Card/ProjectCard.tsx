...
export default function ProjectCard(props: ProjectCardProps) {
  return (
    ...
    >
      <div className="flex-col border border-[--navBarBorder] bg-[#ffffff05] rounded-3xl flex flex-row justify-between">
        <div className="flex flex-col gap-2 p-4 md:p-5  md:py-4  ">
